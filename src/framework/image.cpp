...
void Image::DrawTriangleInterpolated(const Vector3& p0, const Vector3& p1, const Vector3& p2, const Color& c0, const Color& c1, const Color& c2, FloatImage* zBuffer, Image* texture, const Vector2& uv0, const Vector2& uv1, const Vector2& uv2 ) {
    ...
    // Inicializamos la matriz que utilizaremos para obtener las coordenadas baricŽntricas y el vector con dichas coordenadas.
    ...
    for (int y = 0; y < height; y++) {
        ...
        if (table2[y].minX <= table2[y].maxX) {
            ...
            for (int x = table2[y].minX; x < table2[y].maxX; x++) {
                ...
                // Obtenemos las coordenadas baricŽntricas multiplicando la posici—n (x, y) en (forma de vector 3) por la matriz.
                ...
                // Error encontrando las coordenadas baricŽntricas para las UVs (Se pinta un s—lo color por triangulo y no hemos logrado encontrar el error.
